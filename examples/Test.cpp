/*
Test application. Press Shift button to toggle Rain Drops Test Mode. Cue Level knob controls the speed.

Buttons:

Clip 0,0 - Media Play/Pause
Clip 1,0 - Media Stop
Clip 0,1 - Media Prev.
Clip 1,1 - Media Next
...
void OnAPC40Input(double deltatime, std::vector< unsigned char >* message, void*)
{
    ...
    std::cout << "Type: " << input.type << " x: " << input.x << " y: " << input.y << " value: " << input.value << "\n";
